            ...
            <Layout>
                ...
                <div id="main">
                    <section id="one">
                        ...
                        <p>I write code for the web, professionally and as a hobby. My primary tools of the trade these days are React, Node, Express, and GraphQL, but I'm starting to delve into Vue and Svelte, playing around with Electron, and I'd like to get back into Python, learn shell scripting, and C++ at some point.</p>
                        ...
                        <div className="row">
                            ...
                            <div className="4u 12u$(small)">
                                <ul className="labeled-icons">
                                    <li>
                                        <h3 className="fas fa-city"><span className="label">Address</span></h3>
                                    ...
                                    <li>
                                        <h3 className="fas fa-envelope"><span className="label">Email</span></h3>
