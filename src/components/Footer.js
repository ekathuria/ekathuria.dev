    ...
    render() {
        return (
            <div id="footer">
                <div className="inner">
                    <ul className="icons">
                        <li><a href="https://github.ekathuria.com" className="fab fa-github"><span className="label">Github</span></a></li>
                        <li><a href="https://linkedin.com/in/ekathuria" target="_blank" rel="noopener noreferrer" className="fab fa-linkedin"><span className="label">LinkedIn</span></a></li>
