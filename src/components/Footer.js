    ...
    render() {
        return (
            <div id="footer">
                <div className="inner">
                    <div className="icons">
                        <a href="https://github.ekathuria.com" className="fab fa-github"><span className="label">Github</span></a>
                        ...
                        <a href="https://www.notion.so/Reading-List-923600ed9afc4db9b7cb8f99dcda99ed" target="_blank" rel="noopener noreferrer" className="fas fa-film"><span className="label">Books</span></a>
